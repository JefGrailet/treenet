...
public:
	...
	// Accessors/setters with straightforward implementation
	inline InetAddress &getLocalIPAddress() { return this->localIPAddress; }
	inline bool getUseFixedFlowID() { return this->useFixedFlowID; }
	inline void setUseFixedFlowID(bool useFixedFlowID) { this->useFixedFlowID = useFixedFlowID; }
