...
public:
     ...
     * listed rather than InetAddress in order to save the probe token/IP identifiers in the nodes 
     * of inferred subnets before they are written in an output file.
     */
