...
# to evaluate the proportion of some types of fingerprints within a given AS. The script uses 
# three input parameters: a year, a date (both being used to select a dataset) and the path to a
# text file listing the ASes that should be considered at this date.
#
...
if __name__ == "__main__":
    ...
    plt.savefig("TSRequest_" + yearOfMeasurements + "_" + dateOfMeasurements + ".pdf")
    plt.clf()
