...
# Computes a figure showing the amount of probes Ally, RadarGun, MIDAR and TreeNET will use at 
# most to conduct alias resolution. The amounts are not necessarily the exact amount that will be 
# used, they are more like predicted amounts that should however be faithful to experiment. The 
# script requires a .fingerprint and .ip file per AS to compute the right quantities.
...
if __name__ == "__main__":
    ...
    plt.savefig("ProbeAmount_" + yearOfMeasurements + "_" + dateOfMeasurements + ".pdf")
    plt.clf()
