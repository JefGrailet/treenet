...
# uses two input parameters: a date (for the date of measurements) and the path to some text file 
# listing the ASes that should be considered at this date.
#
...
if __name__ == "__main__":
    ...
    plt.savefig("Correlation_" + yearOfMeasurements + "_" + dateOfMeasurements + "_" + ASFilePath + ".pdf")
    plt.clf()
