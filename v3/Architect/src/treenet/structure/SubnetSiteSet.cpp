...
SubnetSite *SubnetSiteSet::getSubnetContaining(InetAddress ip)
{
    for(list<SubnetSite*>::iterator i = siteList.begin(); i != siteList.end(); ++i)
    {
        SubnetSite *ss = (*i);
        ...
        {
            lowerBorder = ss->getPivot();
            upperBorder = ss->getPivot();
        }
...
SubnetSite *SubnetSiteSet::isSubnetEncompassed(SubnetSite *ss)
{
    ...
    {
        ssLowerBorder = ss->getPivot();
        ssUpperBorder = ss->getPivot();
    }
                                 ...
                                 bool shadowExpansion)
{
    for(list<SubnetSite*>::iterator i = siteList.begin(); i != siteList.end(); ++i)
    {
        ...
        {
            lowerBorder2 = ss2->getPivot();
            upperBorder2 = ss2->getPivot();
        }
...
unsigned short SubnetSiteSet::addSite(SubnetSite *ss)
{
    ...
    {
        lowerBorder1 = ss->getPivot();
        upperBorder1 = ss->getPivot();
    }
