...
private:
    ...
    static void listInterfacesRecursive(list<InetAddress*> *interfacesList, NetworkTreeNode *cur);
    static void propagateRecursive(NetworkTreeNode *cur);
    static void visitAndInferRoutersRecursive(NetworkTreeNode *cur);
    static void neighborhoodsRecursive(ostream *out, NetworkTree *tree, NetworkTreeNode *cur);
