 ...
 *
 * This class is essentially a copy-paste from TreeNET Reader v2.0, which some addition due to the 
 * fact that an .ip file produced by TreeNET "ARTest" adds a velocity estimation at the end of 
 * each line, unlike TreeNET v2.1 or TreeNET Reader v2.0.
 */
