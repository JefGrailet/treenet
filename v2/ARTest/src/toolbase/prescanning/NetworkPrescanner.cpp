...
{
    /*
     * N.B.: this implementation is very similar to that of ProbesDispatcher (see full TreeNET), 
     * which was defined last year. However, typing has been updated because unsigned short is way 
     * too small when we want to target large amounts of IPs (for example, entirety of AS224). 
     * Unsigned long has been used instead.
     */
