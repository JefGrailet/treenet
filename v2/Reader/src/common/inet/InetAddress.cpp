 ...
 * InetAddress.cpp
 *
 * This file implements the class "InetAddress" defined in InetAddress.h. The date at which it was 
 * it was written and the author are unknown (but are very likely to be the same as for 
 * InetAddress.h). This class was already in ExploreNET and has been improved coding style-wise in 
 * September 2015 by J.-F. Grailet.
 */
